...
//TODO: Will need documentation update, increments reference
...
//TODO: Remove
void obs_sceneitem_add(obs_scene_t *parent, obs_sceneitem_t *item,
		       obs_sceneitem_t *prev)
{
	full_lock(parent);
	attach_sceneitem(parent, item, prev);
	//set_visibility(item, true); TODO
	full_unlock(parent);
}
